...
np.save('loc_train_dynamic' + suffix + '.npy', loc_train)
np.save('vel_train_dynamic' + suffix + '.npy', vel_train)
np.save('edges_train_dynamic' + suffix + '.npy', edges_train)
...
np.save('loc_valid_dynamic' + suffix + '.npy', loc_valid)
np.save('vel_valid_dynamic' + suffix + '.npy', vel_valid)
np.save('edges_valid_dynamic' + suffix + '.npy', edges_valid)
...
np.save('loc_test_dynamic' + suffix + '.npy', loc_test)
np.save('vel_test_dynamic' + suffix + '.npy', vel_test)
np.save('edges_test_dynamic' + suffix + '.npy', edges_test)
